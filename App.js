  ...
  return (
    <div className="App">
      <div className="calc-wrapper">
        ...
        <div className="row">
          <Button onClick={() => dispatch({type: 'handlesin'})}>sin</Button>
          <Button onClick={() => dispatch({type: 'handlecos'})}>cos</Button>
          <Button onClick={() => dispatch({type: 'handletan'})}>tan</Button>
          <Button onClick={() => dispatch({type: 'handlelog'})}>log</Button>
          <Button onClick={() => dispatch({type: 'handleround'})}>int</Button>
        </div>
        <div className="row">
